    ...
    <aside className="w-64 h-screen bg-white border-r border-gray-200 flex flex-col justify-between p-4 sticky top-0 shrink-0">
      <div>
        ...
        <div className="flex items-center gap-3 px-2 py-4 mb-6">
          ...
          <div>
            <h2 className="font-bold text-gray-800 text-sm leading-tight">DIDELCO</h2>
        ...
        <nav className="space-y-1">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-4 py-3 bg-blue-100 text-blue-600 rounded-xl text-sm font-semibold transition-colors"
          >
          ...
          <Link
            href="#constancias"
            className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-xl text-sm font-medium transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
